...
- Click on View Inventory.
  ...
  "Here you will see colour-coded rows. Green is for newly added menu items, Red is for menu items deleted from the menu, and Orange is if the item is low on stock. You cannot edit any menu items here, only managers can. Proceed with instructions for now."
- Click on home.
- Click on Account in the top bar.
- Click on log off.
...
- Click on Manage Inventory.
  ...
  "Here you will again see colour-coded rows. Green is for newly added menu items, Red is for menu items deleted from the menu, and Orange is if the item is low on stock."
...
- Click on Done to complete the order.
- Click on Home.
- Click on Accounts.
- Click on Log off.
...
- Update the cells of the discount by double-clicking it.
  "You cannot edit discount id, and cannot make the start date go after the end date."
- Create a discount for which the end date is before today.
- Create a discount for which the end date is set to today or after today.
- Click on home.
- Click on Take Order.
- Add items to order.
- Click on Discounts.
