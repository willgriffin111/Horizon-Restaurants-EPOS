...
menuData = [
    ['123', 'Starter 1', '123', '123', 'ingredient'],
...
class App(tk.Tk):
    ...
    def add_staff_pop(self):
        ...
        self.staff_tree = ttk.Treeview(self,height=15)
    ...
    def add_inventory_pop(self):
        ...
        submit = tk.Button(self.inventory_window, width=4, height=2, text='Submit', borderwidth=0,
